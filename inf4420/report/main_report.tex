...
total system. To be sure that every part works as i should, we made own working directories for each part. The naming for the blocks were kept consequently, so that there would not create any problem. 
...
\begin{itemize}
 ...
 \end{itemize}
\end{itemize}
The \textit{Results} section is divided into subsections, where each subsection represent each block in the system. Each sub section contains a simulation part, a component part and a layout part. 
The component part is the actual schematic for the block. The sub-sections is ranged in the same order as in the introduction. In the end, the additional blocks, such as \textit{SR latch}, and 
