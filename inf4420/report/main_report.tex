...
\end{math}
\begin{math}
 \Delta t = 50\mu S - 50.1\mu S = 0.1\mu S \\
 \Delta V_{in} = 600mV - 596.206mV = 3.794mV \\
 \Delta V_{out} = 1.2V \\
 Gain = \freq{1.2V}{3.794mV} = 316.289 \approx 316 \\
\end{math}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Conclusion}
A complete system, for a Successive Approximation Register, Analog to Digital Converter has 
